...
export class KeywordListService {
    ...
    get selectedRowsTexts(): SelectedRowsTextsModel {
        return {
            selectedRows: 'common.keywords are selected',
            selectedRowsOnPage: 'common.keywords are selected on this page',
            filtered: 'common.filtered keywords',
        };
    }

    getKeywords = (params: HttpParams) => {
        params = addFilterParams(params, { operator: 'IN', field: 'type', value: ['keyword'] });
